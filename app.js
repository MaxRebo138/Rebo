...
if(percentage > 50){
resultBox.querySelector(".total-score").innerHTML = correctAnswers + "/" + 10 + ": You Know your Shit, Mofako";
}

if(percentage <= 50){
resultBox.querySelector(".total-score").innerHTML = correctAnswers + "/" + 10 + ": \xa0\xa0\xa0You are a Juff";
}
...
window.onload = function(){
	homeBox.querySelector(".total-question").innerHTML = 10;
}
